...
@_typing.overload
def calibrate(
    objectPoints: _typing.Sequence[cv2.UMat],
    imagePoints: _typing.Sequence[cv2.UMat],
    image_size: cv2.typing.Size,
    K: cv2.UMat,
    D: cv2.UMat,
    rvecs: _typing.Sequence[cv2.UMat] | None = ...,
    tvecs: _typing.Sequence[cv2.UMat] | None = ...,
    flags: int = ...,
    criteria: cv2.typing.TermCriteria = ...,
) -> tuple[
    float, cv2.UMat, cv2.UMat, _typing.Sequence[cv2.UMat], _typing.Sequence[cv2.UMat]
]: ...
@_typing.overload
def distortPoints(
    undistorted: cv2.typing.MatLike,
    K: cv2.typing.MatLike,
    D: cv2.typing.MatLike,
    distorted: cv2.typing.MatLike | None = ...,
    alpha: float = ...,
) -> cv2.typing.MatLike: ...
@_typing.overload
def distortPoints(
    undistorted: cv2.UMat,
    K: cv2.UMat,
    D: cv2.UMat,
    distorted: cv2.UMat | None = ...,
    alpha: float = ...,
) -> cv2.UMat: ...
@_typing.overload
def distortPoints(
    undistorted: cv2.typing.MatLike,
    Kundistorted: cv2.typing.MatLike,
    K: cv2.typing.MatLike,
    D: cv2.typing.MatLike,
    distorted: cv2.typing.MatLike | None = ...,
    alpha: float = ...,
...
@_typing.overload
def projectPoints(
    objectPoints: cv2.UMat,
    rvec: cv2.UMat,
    tvec: cv2.UMat,
    K: cv2.UMat,
    D: cv2.UMat,
    imagePoints: cv2.UMat | None = ...,
    alpha: float = ...,
    jacobian: cv2.UMat | None = ...,
) -> tuple[cv2.UMat, cv2.UMat]: ...
@_typing.overload
def solvePnP(
    objectPoints: cv2.typing.MatLike,
...
def solvePnP(
    ...
    flags: int = ...,
    criteria: cv2.typing.TermCriteria = ...,
) -> tuple[bool, cv2.UMat, cv2.UMat]: ...
@_typing.overload
def stereoCalibrate(
    objectPoints: _typing.Sequence[cv2.typing.MatLike],
    imagePoints1: _typing.Sequence[cv2.typing.MatLike],
    imagePoints2: _typing.Sequence[cv2.typing.MatLike],
    K1: cv2.typing.MatLike,
    D1: cv2.typing.MatLike,
    K2: cv2.typing.MatLike,
    D2: cv2.typing.MatLike,
...
def stereoCalibrate(
    objectPoints: _typing.Sequence[cv2.UMat],
    imagePoints1: _typing.Sequence[cv2.UMat],
    imagePoints2: _typing.Sequence[cv2.UMat],
    K1: cv2.UMat,
    D1: cv2.UMat,
    K2: cv2.UMat,
    D2: cv2.UMat,
...
def stereoCalibrate(
    ...
    flags: int = ...,
    criteria: cv2.typing.TermCriteria = ...,
) -> tuple[float, cv2.UMat, cv2.UMat, cv2.UMat, cv2.UMat, cv2.UMat, cv2.UMat]: ...
@_typing.overload
def stereoRectify(
    K1: cv2.typing.MatLike,
    D1: cv2.typing.MatLike,
...
@_typing.overload
def undistortImage(
    distorted: cv2.typing.MatLike,
    K: cv2.typing.MatLike,
    D: cv2.typing.MatLike,
    undistorted: cv2.typing.MatLike | None = ...,
    Knew: cv2.typing.MatLike | None = ...,
    new_size: cv2.typing.Size = ...,
) -> cv2.typing.MatLike: ...
@_typing.overload
def undistortImage(
