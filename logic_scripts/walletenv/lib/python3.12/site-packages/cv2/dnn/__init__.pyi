...
class Layer(cv2.Algorithm):
    ...
    def run(
        ...
        _typing.Sequence[cv2.typing.MatLike], _typing.Sequence[cv2.typing.MatLike]
    ]: ...
...
class Net:
    ...
    def addLayer(
        self, name: str, type: str, dtype: int, params: cv2.typing.LayerParams
    ) -> int: ...
    def addLayerToPrev(
        self, name: str, type: str, dtype: int, params: cv2.typing.LayerParams
    ) -> int: ...
    ...
    def forwardAndRetrieve(
        self, outBlobNames: _typing.Sequence[str]
    ...
    def getInputDetails(
        self,
    ) -> tuple[_typing.Sequence[float], _typing.Sequence[int]]: ...
    def getOutputDetails(
        self,
    ) -> tuple[_typing.Sequence[float], _typing.Sequence[int]]: ...
    ...
    @_typing.overload
    def setParam(
        self, layerName: str, numParam: int, blob: cv2.typing.MatLike
    ) -> None: ...
    @_typing.overload
    ...
    @_typing.overload
    def getLayersShapes(
        self, netInputShapes: _typing.Sequence[cv2.typing.MatShape]
    ) -> tuple[
        _typing.Sequence[int],
        _typing.Sequence[_typing.Sequence[cv2.typing.MatShape]],
        _typing.Sequence[_typing.Sequence[cv2.typing.MatShape]],
    ]: ...
    @_typing.overload
    def getLayersShapes(self, netInputShape: cv2.typing.MatShape) -> tuple[
        _typing.Sequence[int],
        _typing.Sequence[_typing.Sequence[cv2.typing.MatShape]],
        _typing.Sequence[_typing.Sequence[cv2.typing.MatShape]],
    ]: ...
    ...
    @_typing.overload
    def getFLOPS(
        self, layerId: int, netInputShapes: _typing.Sequence[cv2.typing.MatShape]
    ) -> int: ...
    @_typing.overload
    ...
    def getMemoryConsumption(
        self, netInputShape: cv2.typing.MatShape
    ) -> tuple[int, int]: ...
    @_typing.overload
    def getMemoryConsumption(
        self, layerId: int, netInputShapes: _typing.Sequence[cv2.typing.MatShape]
    ...
    @_typing.overload
    def getMemoryConsumption(
        self, layerId: int, netInputShape: cv2.typing.MatShape
    ) -> tuple[int, int]: ...
...
class Image2BlobParams:
    ...
    def blobRectToImageRect(
        self, rBlob: cv2.typing.Rect, size: cv2.typing.Size
    ) -> cv2.typing.Rect: ...
    def blobRectsToImageRects(
        self, rBlob: _typing.Sequence[cv2.typing.Rect], size: cv2.typing.Size
...
class Model:
    ...
    @_typing.overload
    def predict(
        self, frame: cv2.UMat, outs: _typing.Sequence[cv2.UMat] | None = ...
    ) -> _typing.Sequence[cv2.UMat]: ...
...
class KeypointsModel(Model):
    ...
    @_typing.overload
    def estimate(
        self, frame: cv2.typing.MatLike, thresh: float = ...
    ) -> _typing.Sequence[cv2.typing.Point2f]: ...
    @_typing.overload
    def estimate(
        self, frame: cv2.UMat, thresh: float = ...
    ) -> _typing.Sequence[cv2.typing.Point2f]: ...
...
class SegmentationModel(Model):
    ...
    @_typing.overload
    def segment(
        self, frame: cv2.typing.MatLike, mask: cv2.typing.MatLike | None = ...
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
...
class DetectionModel(Model):
    ...
    @_typing.overload
    def detect(
        self, frame: cv2.UMat, confThreshold: float = ..., nmsThreshold: float = ...
    ) -> tuple[
        _typing.Sequence[int],
        _typing.Sequence[float],
        _typing.Sequence[cv2.typing.Rect],
...
class TextRecognitionModel(Model):
    ...
    def setDecodeOptsCTCPrefixBeamSearch(
        self, beamSize: int, vocPruneSize: int = ...
    ) -> TextRecognitionModel: ...
    def setVocabulary(
        self, vocabulary: _typing.Sequence[str]
    ) -> TextRecognitionModel: ...
    ...
    @_typing.overload
    def recognize(
        self, frame: cv2.typing.MatLike, roiRects: _typing.Sequence[cv2.typing.MatLike]
    ) -> _typing.Sequence[str]: ...
    @_typing.overload
    def recognize(
        self, frame: cv2.UMat, roiRects: _typing.Sequence[cv2.UMat]
    ) -> _typing.Sequence[str]: ...
...
class TextDetectionModel(Model):
    ...
    def detect(
        ...
        _typing.Sequence[_typing.Sequence[cv2.typing.Point]], _typing.Sequence[float]
    ]: ...
    @_typing.overload
    def detect(
        self, frame: cv2.UMat
...
class LayerProtocol(Protocol):
    # Functions
    def __init__(
        self, params: dict[str, DictValue], blobs: _typing.Sequence[cv2.typing.MatLike]
    ) -> None: ...
    def getMemoryShapes(
        self, inputs: _typing.Sequence[_typing.Sequence[int]]
    ) -> _typing.Sequence[_typing.Sequence[int]]: ...
    def forward(
        self, inputs: _typing.Sequence[cv2.typing.MatLike]
    ) -> _typing.Sequence[cv2.typing.MatLike]: ...
...
@_typing.overload
def blobFromImageWithParams(
    image: cv2.typing.MatLike, param: Image2BlobParams = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
def blobFromImageWithParams(
    image: cv2.UMat, param: Image2BlobParams = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
def blobFromImageWithParams(
    image: cv2.typing.MatLike,
    blob: cv2.typing.MatLike | None = ...,
    param: Image2BlobParams = ...,
) -> cv2.typing.MatLike: ...
@_typing.overload
def blobFromImageWithParams(
    image: cv2.UMat, blob: cv2.UMat | None = ..., param: Image2BlobParams = ...
) -> cv2.UMat: ...
@_typing.overload
def blobFromImages(
...
@_typing.overload
def blobFromImages(
    images: _typing.Sequence[cv2.UMat],
    scalefactor: float = ...,
    size: cv2.typing.Size = ...,
    mean: cv2.typing.Scalar = ...,
    swapRB: bool = ...,
...
@_typing.overload
def blobFromImagesWithParams(
    images: _typing.Sequence[cv2.typing.MatLike], param: Image2BlobParams = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
def blobFromImagesWithParams(
    images: _typing.Sequence[cv2.UMat], param: Image2BlobParams = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
def blobFromImagesWithParams(
    images: _typing.Sequence[cv2.typing.MatLike],
...
@_typing.overload
def imagesFromBlob(
    blob_: cv2.typing.MatLike, images_: _typing.Sequence[cv2.UMat] | None = ...
) -> _typing.Sequence[cv2.UMat]: ...
@_typing.overload
...
def readNetFromCaffe(
    bufferProto: numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]],
    bufferModel: numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]] = ...,
) -> Net: ...
@_typing.overload
def readNetFromDarknet(cfgFile: str, darknetModel: str = ...) -> Net: ...
@_typing.overload
def readNetFromDarknet(
    bufferCfg: numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]],
    bufferModel: numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]] = ...,
) -> Net: ...
@_typing.overload
def readNetFromModelOptimizer(xml: str, bin: str = ...) -> Net: ...
@_typing.overload
def readNetFromModelOptimizer(
    bufferModelConfig: numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]],
    bufferWeights: numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]],
) -> Net: ...
@_typing.overload
...
@_typing.overload
def readNetFromONNX(
    buffer: numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]],
) -> Net: ...
@_typing.overload
def readNetFromTFLite(model: str) -> Net: ...
@_typing.overload
def readNetFromTFLite(
    bufferModel: numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]],
) -> Net: ...
@_typing.overload
def readNetFromTensorflow(model: str, config: str = ...) -> Net: ...
@_typing.overload
def readNetFromTensorflow(
    bufferModel: numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]],
    bufferConfig: numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]] = ...,
) -> Net: ...
...
def shrinkCaffeModel(
    src: str, dst: str, layersTypes: _typing.Sequence[str] = ...
) -> None: ...
def softNMSBoxes(
    bboxes: _typing.Sequence[cv2.typing.Rect],
    scores: _typing.Sequence[float],
    score_threshold: float,
    nms_threshold: float,
    top_k: int = ...,
